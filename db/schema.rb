...
ActiveRecord::Schema.define(version: 2019_01_17_174626) do
  ...
  create_table "club_reviews", force: :cascade do |t|
    ...
    t.index ["club_id"], name: "index_club_reviews_on_club_id"
    t.index ["user_id"], name: "index_club_reviews_on_user_id"
  end
  ...
  add_foreign_key "club_reviews", "clubs"
  add_foreign_key "club_reviews", "users"
